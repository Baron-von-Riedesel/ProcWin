...
typedef (WINAPI * LPSHPARSEDISPLAYNAME)(PCWSTR, void *, LPCITEMIDLIST *, SFGAOF, SFGAOF *);
typedef (WINAPI * LPSHOPENFOLDERANDSELECTITEMS)(LPCITEMIDLIST, UINT, LPCITEMIDLIST, DWORD);
